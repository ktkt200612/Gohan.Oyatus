...
<div class="container">
  ...
  @csrf
    <button type="submit"  name="id" value="{{ $form->id }}" class="container-button">
      <div class="photo">
        <img src="data:/png;base64,{{ $form->outside_photo }}"   width="300" height="300" class="outside" onerror="this.src='image/no_image.png';this.onerror=false;" ><img src="data:/png;base64,{{ $form->inside_photo }}"  width="300" height="300" class="inside" onerror="this.src='image/no_image.png';this.onerror=false;" >
      </div>
